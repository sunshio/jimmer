...
drop table book_author_mapping;
drop table book;
drop table author;
...
values (1, 'O''REILLY', current_timestamp(), current_timestamp()),
       (2, 'MANNING', current_timestamp(), current_timestamp())
;

insert into book(id, name, edition, price, store_id, tenant, created_time, modified_time)
values (1, 'Learning GraphQL', 1, 50, 1, 'a', current_timestamp(), current_timestamp()),
...
insert into tree_node(node_id, name, parent_id, created_time, modified_time)
values (1, 'Home', null, current_timestamp(), current_timestamp()),
